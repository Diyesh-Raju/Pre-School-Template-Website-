...
// 21st.dev template, placed as-is. Note: `animate-in fade-in-0` is a
// tailwindcss-animate utility which isn't installed in this project, so the
// modal appears without a fade (harmless — no error, just no transition).
      ...
      <>
        <div
          ...
          className={cn(
            ...
            "focus-visible:outline-none focus-visible:ring-2 focus-visible:ring-[#FF7F50] focus-visible:ring-offset-2",
            className
          )}
          style={{ aspectRatio }}
